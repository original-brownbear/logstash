 ...
 * <p>
 * This enum provides identifiers for configuring consistency levels for RaftQuery queries
...
public enum ReadConsistency {
     ...
     * this constraint allows reads from followers. When a sequential RaftQuery is submitted to the cluster, the first
     ...
     * linearizable RaftQuery is submitted to the Raft cluster with linearizable consistency,
     ...
     * When a RaftQuery is submitted to the cluster with linearizable consistency, it must be
     ...
     * in the process of contacting a majority of the cluster, it will queue the RaftQuery to
