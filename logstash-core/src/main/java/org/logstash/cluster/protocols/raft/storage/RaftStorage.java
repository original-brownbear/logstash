...
import org.logstash.cluster.protocols.raft.storage.snapshot.SnapshotFile;
...
public class RaftStorage {
     ...
     * </pre>
     */
    public static class Builder implements org.logstash.cluster.utils.Builder<RaftStorage> {
