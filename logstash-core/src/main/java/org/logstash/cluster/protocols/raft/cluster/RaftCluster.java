 ...
 * {@link org.logstash.cluster.protocols.raft.RaftServer} is started, the server will form a cluster
 ...
 * cluster by calling {@link org.logstash.cluster.protocols.raft.RaftServer#bootstrap(MemberId...)}  or {@link #join(MemberId...)},
 ...
 * {@link org.logstash.cluster.storage.StorageLevel}, cluster configurations are stored on disk.
 ...
 * full cluster shutdown (assuming the server uses a persistent {@link org.logstash.cluster.storage.StorageLevel}).
 */
public interface RaftCluster {
     ...
     * {@link org.logstash.cluster.storage.StorageLevel}), the term is guaranteed to be unique and monotonically increasing even across
     ...
     * Leaves the cluster.
     *
     * Invocations of this method will cause the local {@link org.logstash.cluster.protocols.raft.RaftServer} to leave the cluster.
     * <em>This method is for advanced usage only.</em> Typically, users should use {@link org.logstash.cluster.protocols.raft.RaftServer#leave()}
