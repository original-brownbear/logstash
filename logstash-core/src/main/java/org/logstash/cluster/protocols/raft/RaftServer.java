...
import org.logstash.cluster.protocols.raft.impl.DefaultRaftServer;
import org.logstash.cluster.protocols.raft.impl.RaftServiceFactoryRegistry;
 ...
 * to which to bind the internal {@link RaftServerProtocol} and a set of addresses
 ...
 * memory instead of disk, configure the {@link org.logstash.cluster.storage.StorageLevel}.
 * <pre>
 * {@code
 * RaftServer server = RaftServer.builder(address)
 *   .withStateMachine(MyStateMachine::new)
...
public interface RaftServer {
     ...
     * list provided to the server {@link #builder(MemberId) builder}. For {@link org.logstash.cluster.storage.StorageLevel#DISK persistent}
     ...
     * </pre>
     */
    abstract class Builder implements org.logstash.cluster.utils.Builder<RaftServer> {
